...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
        ...
        $store = "img/Career_Abroad/" . basename($fname);
        ...
        if (in_array($extension, $allowedExtensions)) {
            if ($fsize >= 100000000) {
                ...
                $sql = "INSERT INTO career_abroad(category, image) VALUE('".$category."','".$fname."')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="career_abroad.php" class="nav-item nav-link active"><i class="fa fa-child me-2"></i>Career Abroad</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <?php 
                                ...
                                echo $success;
                            ?>
                            <h6 class="mb-4">Career Abroad</h6>
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-select mb-3" name="category" aria-label="Default select example">
                                    ...
                                    <option value="Nurses To Germany">Nurses To Germany</option>
                                    <option value="Drivers To Germany">Drivers To Germany</option>
                                    <option value="Doctors To Spain">Doctors To Spain</option>
                                </select>
                                <div class="mb-3 ">
                                    <label for="formFileSm" class="form-label">Image</label>
                                    <input class="form-control form-control bg-dark" name="image" id="formFileSm" type="file">
                                </div>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM career_abroad ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            <td>'.$i.'</td>
                                            <td>'.$rows['category'].'</td>
                                            <td><img style="width: 50px; height: 50px;" src="img/Career_Abroad/'.$rows['image'].'" alt="Avatar" class="rounded-circle" /></td>
                                            ';
                                       ...
                                       if ($rows['status']) {
                                        // code...
                                        echo "<td><a href='hide_career.php?career=".$rows['id']."' id='button' class='btn btn-success btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye-slash'></i></a></td>"; 
                                      }
                                      else{
                                        echo "<td><a href='show_career.php?career=".$rows['id']."' id='button' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye'></i></a></td>"; 

                                      } 

                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_career.php?career=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
