...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
        ...
        $store = "img/Event/" . basename($fname);
        ...
        if (in_array($extension, $allowedExtensions)) {
            if ($fsize >= 100000000) {
                ...
                $sql = "INSERT INTO event(image) VALUE('" . $fname . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="event.php" class="nav-item nav-link active"><i class="fa fa-image me-2"></i>Event</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM event ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                ...
                                if(!mysqli_num_rows($result) > 0 )
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            <td>'.$i.'</td>
                                            <td><img style="width: 50px; height: 50px;" src="img/Event/'.$rows['image'].'" alt="Avatar" class="rounded-circle" /></td>
                                       ...
                                       if ($rows['status']) {
                                        // code...
                                        echo "<td><a href='hide_event.php?event=".$rows['id']."' id='button' class='btn btn-success btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye-slash'></i></a></td>"; 
                                      }
                                      else{
                                        echo "<td><a href='show_event.php?event=".$rows['id']."' id='button' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye'></i></a></td>"; 

                                      } 

                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_event.php?cat_del=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
