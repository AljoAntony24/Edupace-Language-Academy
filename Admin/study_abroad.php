    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
            ...
            $description = $_POST['description'];
                    ...
                    $sql = "INSERT INTO study_abroad(category,youtube_link,description) VALUE('".$category."','".$youtube."','" . $description . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="study_abroad.php" class="nav-item nav-link active"><i class="fa fa-bookmark me-2"></i>Study Abroad</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-select mb-3" name="category" aria-label="Default select example">
                                    ...
                                    <option value="Ausbildung In Germany">Ausbildung In Germany</option>
                                    <option value="Vocational Training Program">Vocational Training Program</option>
                                    <option value="Master Program At Germany">Master Program At Germany</option>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="youtube" id="basic-url" aria-describedby="basic-addon3">
                                </div>
                                <div class="mb-3">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM study_abroad ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            <td>'.$i.'</td>
                                            <td>'.$rows['category'].'</td>
                                            <td><iframe  src="https://www.youtube.com/embed/'.$rows["youtube_link"].'" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe></td>
                                      ...
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_study_abroad.php?study=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
                      ...
                      $result_db = mysqli_query($con,"SELECT COUNT(ID) FROM study_abroad"); 
