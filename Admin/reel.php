...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
                ...
                $sql = "INSERT INTO video_reel(youtube_link) VALUE('" . $youtube . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="reel.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Reel</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM video_reel ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                       ...
                                       if ($rows['status']) {
                                        // code...
                                        echo "<td><a href='hide_reel.php?reel=".$rows['id']."' id='button' class='btn btn-success btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye-slash'></i></a></td>"; 
                                      }
                                      else{
                                        echo "<td><a href='show_reel.php?reel=".$rows['id']."' id='button' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye'></i></a></td>"; 

                                      } 

                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_reel.php?reel=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
