    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <?php
                ...
                {
                  $sql = "update testimonials set name='$_POST[name]',place='$_POST[place]',description='$_POST[description]' where id='$_GET[upd]' ";  // store the submited data ino the database :images                        
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <?php 
                                    $ssql ="select * from testimonials where id='$_GET[upd]'";
                                    $res=mysqli_query($con, $ssql); 
                                    $row=mysqli_fetch_array($res);
                                  ?>
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Name</label>
                                    <input type="text" class="form-control" name="name" id="basic-url" style="color:white;" value="<?php echo $row['name'] ?>" aria-describedby="basic-addon3">
                                </div>
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Place</label>
                                    <input type="text" class="form-control" name="place" id="basic-url" style="color:white;" value="<?php echo $row['place'] ?>" aria-describedby="basic-addon3">
                                </div>
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Description</label>
                                    <textarea type="text" class="form-control" name="description"  aria-describedby="basic-addon3" id="description"><?php echo $row['description'] ?></textarea>
                                </div>
