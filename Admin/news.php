...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
            $News=$_POST['news'];    
            $sql = "INSERT INTO news(news_feed) VALUE('" . $News . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="news.php" class="nav-item nav-link active"><i class="fa fa-image me-2"></i>Scroll News</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="formFileMultiple" class="form-label">Scroll News</label>
                                    <input class="form-control bg-dark" name="news" type="text" placeholder="Enter Your News">
                                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM news ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                       ...
                                       if ($rows['status']) {
                                        // code...
                                        echo "<td><a href='hide_news.php?news=".$rows['id']."' id='button' class='btn btn-success btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye-slash'></i></a></td>"; 
                                      }
                                      else{
                                        echo "<td><a href='show_news.php?news=".$rows['id']."' id='button' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye'></i></a></td>"; 

                                      } 

                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_news.php?news=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
                      ...
                      $result_db = mysqli_query($con,"SELECT COUNT(ID) FROM news"); 
