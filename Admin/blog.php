    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
        ...
        if (in_array($extension, $allowedExtensions)) {
            if ($fsize >= 100000000) {
                ...
                $sql = "INSERT INTO blog(name, title, description, image) VALUES('" . $name . "','" . $title . "','" . $description . "','" . $fname . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="blog.php" class="nav-item nav-link active"><i class="far fa-file-alt me-2"></i>Blog</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="mb-3 form-check"> 
                                    ...
                                    <input type="text" class="form-control" name="name" id="basic-url" placeholder="Enter Your Name" aria-describedby="basic-addon3">
                                </div>
                                ...
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Heading</label>
                                    <input type="text" class="form-control" name="title" id="basic-url"  placeholder="Enter Your Place" aria-describedby="basic-addon3">
                                </div>
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Description</label>
                                    <textarea type="text" class="form-control" id="description" name="description" placeholder="Description" aria-describedby="basic-addon3"></textarea>
                                </div>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                            ...
                                            <td>'.$rows['name'].'</td>
                                            <td><img style="width: 50px; height: 50px;" src="img/Blog/'.$rows['image'].'" alt="Avatar" class="rounded-circle" /></td>
                                            <td>'.$rows['place'].'</td>
                                            <td style="text-align:justify;">'.$rows['description'].'</td>
                                            <td>'.$rows['date'].'</td>
                                      ...
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_blog.php?blog=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'><i class='fa fa-trash'></i></a>
                                            </td></tr>";
