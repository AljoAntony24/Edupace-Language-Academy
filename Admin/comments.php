        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="comments.php" class="nav-item nav-link active"><i class="fa fa-comments me-2"></i>Comments</a>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <?php 
                                    ...
                                    $result = mysqli_query($con,"SELECT * FROM comments ORDER BY ID desc LIMIT $start_from, $limit");
                                    ?>
                                <table class="table">
                                    <thead>
                                        <tr>
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo ' <tr>
                                       ...
                                       if ($rows['status']) {
                                        // code...
                                        echo "<td><a href='hide_comments.php?banner_del=".$rows['id']."' id='button' class='btn btn-success btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye-slash'></i></a></td>"; 
                                      }
                                      else{
                                        echo "<td><a href='show_comments.php?banner_del=".$rows['id']."' id='button' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'><i class='fa fa-eye'></i></a></td>"; 

                                      } 

                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_comments.php?cat_del=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:20px; padding:5px;'><i class='fa fa-trash'></i></a></td></tr>";
