...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['token']) && hash_equals($_SESSION['token'], $_POST['token'])) {
                ...
                $sql = "INSERT INTO testimonials(name,place,description) VALUE('" . $title . "','" . $place . "','" . $description . "')";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="testimonials.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Testimonials</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Place</label>
                                    <input type="text" class="form-control" name="place" id="basic-url" placeholder="Enter Your Place" aria-describedby="basic-addon3">
                                </div>
                                <div class="mb-3 form-check"> 
                                    <label for="basic-url" class="form-label">Description</label>
                                    <textarea type="text" class="form-control" name="description" placeholder="Description" aria-describedby="basic-addon3" id="description"></textarea>
                                </div>
                                ...
                                if(!mysqli_num_rows($result) > 0 )
                                  ...
                                  {  
                                    ...
                                    while($rows=mysqli_fetch_array($result))
                                    {
                                      ...
                                      echo   "<td><a  onClick=\"javascript:return confirm('Do you wants to delete this?');\" href='delete_testimonials.php?test=".$rows['id']."' class='btn btn-danger btn-flat btn-addon btn-xs m-b-10'  style='font-size:15px; padding:5px;'><i class='fa fa-trash'></i></a>";
