                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <?php    
                                $sql="select * from video_reel";
                                $result=mysqli_query($con,$sql); 
                                $rws=mysqli_num_rows($result);
                              ?>
                            <div class="ms-3">
                                <p class="mb-2">Video Reel</p>
                                <h6 class="mb-0"><?php echo $rws; ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <?php    
                              ...
                              ?>
                            <div class="ms-3">
                                <p class="mb-2">Get In Touch With Us</p>
                                <h6 class="mb-0"><?php echo $rws; ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <!-- <i class="fa fa-chart-pie fa-3x text-primary"></i> -->
                            <?php    
                                $sql="select * from language_training";
                                $result=mysqli_query($con,$sql); 
                                $rws=mysqli_num_rows($result);
                              ?>
                            <div class="ms-3">
                                <p class="mb-2">Language Training</p>
                                <h6 class="mb-0"><?php echo $rws; ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <!-- <i class="fa fa-chart-pie fa-3x text-primary"></i> -->
                            <?php    
                                $sql="select * from career_abroad";
                                $result=mysqli_query($con,$sql); 
                                $rws=mysqli_num_rows($result);
                              ?>
                            <div class="ms-3">
                                <p class="mb-2">Career Abroad</p>
                                <h6 class="mb-0"><?php echo $rws; ?></h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 text-center text-sm-end">
                            ...
                            Designed By <a href="plusitpark.com">Plus IT B Park</a>
                            <br>Distributed By: <a href="https://themewagon.com" target="_blank">Web Updates</a>
                        </div>
                    </div>
                </div>
            </div>
