...
<div class="home-body-container">
  ...
  <div class="tabcontents container">
      ...
      <div class="tabcontent" id="tab_div2">
          ...
          <div class="row education-card-container">
              <div class="col-md-4 mb-4">
                  <div class="card edu-card" onclick="location.href='../ielts';">
              ...
              <div class="col-md-4 mb-4">
                  <div class="card edu-card" onclick="location.href='../OET_Exam_Preparation_in_Nurses';">
                      <img src="../assets/index/services/Thrissur No-1 OET Coaching Center.jpg" class="card-img-top" alt="Best Study Abroad in Thrissur" />
                  </div>
              </div>
              <div class="col-md-4 mb-4">
                  <div class="card edu-card" onclick="location.href='../German_Language_Training';">
      ...
      <div class="tabcontent" id="tab_div2">
          ...
          <div class="row education-card-container">
              <div class="col-md-4 mb-4">
                  <div class="card edu-card" onclick="location.href='../French_Language_Training';">
              ...
              <div class="col-md-4 mb-4">
                  <div class="card edu-card" onclick="location.href='../spanish_Language_Training';">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align:justify; font-family: PT-serif; font-size:17px;"><a href="" style="text-decoration: none; color:black;" target="_blank" rel="nofollow"><?php echo $user_data['description']; ?></a></p>
                  </div>
                </div>
            </div>
          <?php } ?>
